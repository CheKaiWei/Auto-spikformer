...
class PatchembedSuper(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768, scale=False):
        ...
        # self.proj_bn = BNSuper(super_out_dim=embed_dim//8, dim_1d_2d='2d')
        ...
        # self.proj_bn1 = BNSuper(super_out_dim=embed_dim//4, dim_1d_2d='2d')
        ...
        # self.proj_bn2 = BNSuper(super_out_dim=embed_dim//2, dim_1d_2d='2d')
        ...
        self.proj_bn3 = BNSuper(super_out_dim=embed_dim, dim_1d_2d='2d')
        ...
        self.rpe_bn = BNSuper(super_out_dim=embed_dim, dim_1d_2d='2d')
